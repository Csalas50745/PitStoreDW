...
drop schema if exists PitStoreDW;
drop user if exists usuario_prueba;
CREATE SCHEMA PitStoreDW ;

/*Se crea un usuario para la base de datos llamado "usuario_prueba" y tiene la contraseña "Usuario_Clave."*/
create user 'usuario_prueba'@'%' identified by 'Usuar1o_Clave.';

/*Se asignan los prvilegios sobr ela base de datos PitStoreDW al usuario creado */
grant all privileges on PitStoreDW.* to 'usuario_prueba'@'%';
flush privileges;
...
INSERT INTO usuario (id_usuario, username,password,nombre, apellidos, correo, telefono,imagen,activo) VALUES 
...
INSERT INTO categoria (id_categoria,descripcion,imagen,activo) VALUES 
...
INSERT INTO producto (id_producto,id_categoria,descripcion,detalle,precio,existencias,imagen,activo) VALUES
